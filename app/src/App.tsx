...
class App extends React.Component<any, any> {
  ...
  public testSignMessage = async () => {
    ...
    // test message
    const message = "0x616664736166646173666164736661736466";
  ...
  public getDataAxios = async (verified: string) => {
    try{
    const response = await axios.get("http://api.iologics.co.uk/kickback/checkin.php?event_id=1&wallet_id="+verified+"&event_name=kickbackevent");
      ...
      <SLayout>
        ...
        <Modal show={showModal} toggleModal={this.toggleModal}>
          {pendingRequest ? (
            ...
            <SModalContainer>
              <SModalTitle>{"You are checked-in!"}</SModalTitle>
              <STable>
